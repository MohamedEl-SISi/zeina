(function ($) {
    ...
    if( $('#chartjs-market-trends-chart').length ) {
        ...
        var data = $('#chartjs-market-trends-chart')
            data =  JSON.parse(data.attr('data-data'))

        var label=[];
        var dataset=[];

        $.each(data, function(item) {
            label.push(data[item].name)
            dataset.push(data[item].count)
        });
    ...
    if( $('#chartjs-market-trends-chart1').length ) {

        var data = $('#chartjs-market-trends-chart1')
        data =  JSON.parse(data.attr('data-data'))
        ...
        var MTC = document.getElementById('chartjs-market-trends-chart1').getContext('2d');
    ...
    if( $('#chartjs-market-trends-chart11').length ) {

        var data = $('#chartjs-market-trends-chart11')
        data =  JSON.parse(data.attr('data-data'))
        ...
        var MTC = document.getElementById('chartjs-market-trends-chart11').getContext('2d');
