...
<div class="breadCrumb mt15">
  <div class="breadCrumb__list"><span class="icon breadCrumb__home">
    ...
    <li class="breadCrumb__item"><a class="breadCrumb__link">ملفات زينة</a></li><span class="icon">
  </div>
</div>
  ...
  <div class="layout-wrap">
    <section class="main-section">
      <div class="row cont">
              @each('website.shared.FileSpecailCard',$data,'item')
      </div>
        @if(count($data)==10)
