                        ...
                        <div class="row mbn-20">
                            <div class="col-lg-12 col-12 mb-20">
                                <div class="row mbn-15">
                                    @if(isset($new_edit))
                                          {!!Form::model($new_edit,array('url'=>url('dashboard/articles/'.$new_edit->id),'method' => 'PATCH','files'=>true,'style'=>'width: 100%',"class"=>"row justify-content-center"))!!}
                                            ...
                                            @endphp
                                    @else
                                        {!!Form::open(array('url'=>url('dashboard/articles'),'files'=>true,'style'=>'width: 100%',"class"=>"row justify-content-center"))!!}
                                    @endif
                                      ...
                                      @endphp
                                        ...
                                        <div class="col-lg-6 mb-15">
                                            ...
                                            {!!Form::text('title',null,array('class'=>'form-control ','placeholder'=>'عنوان المقال','autocomplete'=>'title','required'=>'required','id'=>'name'))!!}
                                        </div>
                                        ...
                                        <div class="col-lg-6 mb-15">
                                            ...
                                            @if(isset($new_edit))
                                                ...
                                                @if(is_null($new_edit->slug))
                                                      {!!Form::text('slug',null,array('class'=>'form-control ','placeholder'=>'عنوان الخبر','id'=>'slug','autocomplete'=>'title','required'=>'required'  ))!!}
                                                @else
                                                  <span>{{$new_edit->slug}}</span>
                                                @endif
                                            @else
                                                {!!Form::text('slug',null,array('class'=>'form-control ','placeholder'=>'عنوان المقال','id'=>'slug','autocomplete'=>'title','required'=>'required' ,"maxlength"=>"65" ))!!}
                                            @endif
                                        </div>
                                        ...
                                        <div class="col-lg-4 mb-15">
                                            ...
                                            {!!Form::text('publisher_name',null,array('class'=>'form-control ','placeholder'=>'اسم الناشر','autocomplete'=>'title','required'=>'required','id'=>'name'))!!}
                                        </div>
                                        <div class="col-lg-4 mb-15">
                                            {!! Form::label('sectionId', 'تصنيف المقال') !!}
                                        ...
                                        <div class="col-12 mb-15">
                                            @if(isset($new_edit))
                                                ...
                                                @endphp
                                            @endif
                                            {!! Form::label('desc', ' نص  مختصر عن المقال') !!}
                                                                            ...
                                                                            {!! Form::label('photo-body', 'صوره الفقرة') !!}
                                                                              ...
                                                                              @foreach($content['photos']??[] as $indexAlbum => $album_image)
                                                                                  ...
                                                                                  <img src="{{$album_image['image_thumb']}}">
                                                                                    ...
                                                                                    {!!Form::select('content['.$key.'][size][]',collect($mediaSizes)->pluck('name','id'),isset($content['size'])?$content['size'][$indexAlbum]:'600x340',array('class'=>'form-control '))!!}
                                                                                  </div>
                                                                              @endforeach
                                        ...
                                        <div class="col-12 row mb-15">
                                            {!! Form::label('relatednews', 'مقالات متعلقه') !!}
        ...
        <div class="single-wrap_box">
            ...
            <div class="single-wrap_box__bottom">
                <div class="full-width row justify-content-center body-content mb-15 mt-15">
                    ...
                    <div class="col-12 mb-10">
                        {!! Form::label('body', ' نص المقال') !!}
                        {!!Form::textarea('content[index][content]',null,array('class'=>"form-control","onpaste"=>"removestyle()"))!!}
                    </div>
    ...
    box2.val(slug.split(' ').join('-'));
        ...
        $(document).on("click",".bodyContent", function () {
          ...
          var divBodyIndex = $('#bodyImages').attr('div-data')
            ...
            '<select class="form-control " name="content['+divBodyIndex+'][size][]"><option value="src" >src</option><option value="300x250">300x250</option><option selected="selected" value="600x340">600x340</option><option value="200x320">200x320</option><option value="300x150">300x150</option></select> </div');
            }
