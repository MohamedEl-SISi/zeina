                        ...
                        <div class="row mbn-20">
                            <div class="col-lg-12 col-12 mb-20">
                                <div class="row mbn-15">
                                    @if(isset($section_edit) )
                                        {!!Form::model($section_edit,array('url'=>url('dashboard/section/'.$section_edit->id),'method' => 'PATCH','files'=>true,'style'=>'width: 100%','class'=>'row justify-content-center'))!!}
                                    @else
                                        {!!Form::open(array('url'=>url('dashboard/section'),'files'=>true,'style'=>'width: 100%','class'=>'row justify-content-center'))!!}
                                    @endif
                                        ...
                                        <div class="col-12 mb-15">
                                            {!! Form::label('parentId', 'نوع التصنيف') !!}
                                            {!!Form::select('parentId',collect($section)->pluck('name','id'),null,array('class'=>'form-control ','id'=>'parent','required'=>'required'))!!}
                                        </div>
                                    ...
                                    <div class="col-lg-12 mb-15">
                                        ...
                                        {!!Form::textarea('desc',null,array('class'=>'form-control ','autocomplete'=>'off','placeholder'=>'الوصف','maxlength'=>"160"))!!}
                                    </div>
