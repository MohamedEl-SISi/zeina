...
@section('title','section | Home order |')
@section('content')
        ...
        <div class="row justify-content-between align-items-center mb-10">
            <div class="col-12 col-lg-auto mb-20">
                <div class="page-heading">
                        <h3>ترتيب التصنيفات في الرئيسية</h3>
                </div>
            </div>
        </div>
                        ...
                        <div class="row mbn-20">
                            <div class="col-lg-12 col-12 mb-20">
                                <div class="row mbn-15">
                                        {!!Form::open(array('url'=>url('dashboard/section/orderSave'),'files'=>true,'style'=>'width: 100%',"class"=>"row justify-content-center"))!!}
                                        ...
                                        <div class="col-lg-8 col-12 mb-30 ">
                                                <div class="box">
                                                   <div class="box-body">
                                                     <div class="col-12 mb-15">
                                                         {!! Form::label('number', 'عدد التصنيفات في الرئيسية') !!}
                                                         {!!Form::number('no',null,array('class'=>'form-control','placeholder'=>'عدد التصنيفات في الرئيسية','required'=>'required'))!!}
                                                    </div>
